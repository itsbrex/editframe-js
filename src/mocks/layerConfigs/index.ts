import { mockAudioOptions } from 'mocks/layerConfigs/audio'
import { mockBackgroundOptions } from 'mocks/layerConfigs/background'
...
export const defaultBackgroundOptions = mockBackgroundOptions()
